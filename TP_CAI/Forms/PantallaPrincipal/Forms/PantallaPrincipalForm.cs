...
namespace TP_CAI.Archivos.PantallaPrincipal.Forms
{
    public partial class PantallaPrincipalForm : Form
    {
        ...
        {
            OrdenDePreparacionForm recepcionOrdenesPreparacionForm = new OrdenDePreparacionForm();
            this.Hide();
        ...
        {
            OrdenDeSeleccionForm generacionOrdenesSeleccionForm = new OrdenDeSeleccionForm();
            this.Hide();
