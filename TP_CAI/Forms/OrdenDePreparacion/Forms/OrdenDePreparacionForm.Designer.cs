namespace TP_CAI.Archivos.OrdenDePreparacion.Forms
{
    partial class OrdenDePreparacionForm
    {
		...
		private void InitializeComponent()
		{
			...
			AgregarProductoButton.Location = new Point(232, 137);
			AgregarProductoButton.Name = "AgregarProductoButton";
			AgregarProductoButton.Size = new Size(181, 23);
			...
			// 
			ProductosDisponiblesListView.Columns.AddRange(new ColumnHeader[] { IdProducto, DescripcionProducto, CantProducto, UbicacionProducto, columnHeader1 });
			...
			DescripcionProducto.Width = 160;
			// 
			// CantProducto
			// 
			CantProducto.Text = "Cantidad";
			CantProducto.Width = 100;
			// 
			// UbicacionProducto
			// 
			UbicacionProducto.Text = "Ubicacion";
			UbicacionProducto.Width = 100;
			// 
			// InfoOrdenGroup
			// 
			...
			// 
			ProductosAgregadosListView.Columns.AddRange(new ColumnHeader[] { columnHeader2, columnHeader3, columnHeader4, columnHeader5, columnHeader6 });
			...
			// columnHeader3
			// 
			columnHeader3.Text = "Descripcion Producto";
